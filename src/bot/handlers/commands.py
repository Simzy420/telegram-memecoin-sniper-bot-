...
async def cmd_start(message: Message, command: CommandObject) -> None:
    ...
    text = (
        ...
        f"<b>The troop</b>\n"
        f"◈ <b>Scout</b> — finds pairs and setups\n"
        f"◎ <b>Sniper</b> — memecoin entries\n"
        f"▹ <b>Pulse</b> — rapid day trader / tape\n"
        f"▤ <b>Ledger</b> — positions, fills, day log\n"
        f"▣ <b>Shield</b> — risk filters before entry\n\n"
